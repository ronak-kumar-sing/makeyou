          ...
          <div className="text-center mt-16">
            ...
            <ClickSpark sparkColor="#4C8EFF" sparkCount={10} sparkRadius={20}>
              <button
                ...
                className="px-8 py-4 bg-[#4C8EFF] text-white text-base font-semibold rounded-full hover:bg-[#3d7de6] transition-all shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40"
              >
                Let's Get Started
              </button>
            </ClickSpark>
